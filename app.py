...
def cosine_similarity(vec1, vec2):
    ...
    if vec1 is None or vec2 is None:
        logger.error("One or both vectors are None in cosine_similarity")
        return 0.0  # Return 0 similarity for None vectors
    ...
    try:
        ...
        # Also check for zero norms to avoid division by zero
